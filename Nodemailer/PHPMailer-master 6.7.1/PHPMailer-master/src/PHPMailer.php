...
class PHPMailer
{
   ...
   * (e.g. "smtp1.tenkiweb.com:25;smtp2.tenkiweb.com").
   * You can also specify encryption type, for example:
   * (e.g. "tls://smtp1.tenkiweb.com:587;ssl://smtp2.tenkiweb.com:465").
   ...
   *
   * ```php
   * PHPMailer::validateAddress('user@tenkiweb.com', function($address) {
   ...
   *                     [['joe@tenkiweb.com', 'Joe User'], ['zoe@tenkiweb.com', 'Zoe User']]
   *
   * @return string
   */
