  ...
  (a(document).mouseup((a) => {
    ...
    a.widget('ui.mouse', {
      ...
      _mouseInit() {
        const b = this;
        (this.element
          .bind(`mousedown.${this.widgetName}`, (a) => b._mouseDown(a))
          .bind(`click.${this.widgetName}`, (c) => {
 ...
 */ (function (a, b) {
  ...
  const d = /top|center|bottom/;
  const e = 'center';
  const f = {};
  const g = a.fn.position;
  const h = a.fn.offset;
  ((a.fn.position = function (b) {
    ...
    const h = a(b.of);
    const i = h[0];
    const j = (b.collision || 'flip').split(' ');
    const k = b.offset ? b.offset.split(' ') : [0, 0];
    let l;
    let m;
    let n;
    (i.nodeType === 9
    ...
    return this.each(function () {
      const c = a(this);
      const d = c.outerWidth();
      const g = c.outerHeight();
      const h = parseInt(a.curCSS(this, 'marginLeft', !0)) || 0;
      const i = parseInt(a.curCSS(this, 'marginTop', !0)) || 0;
      const o = d + h + (parseInt(a.curCSS(this, 'marginRight', !0)) || 0);
      const p = g + i + (parseInt(a.curCSS(this, 'marginBottom', !0)) || 0);
      const q = a.extend({}, n);
      let r;
            ...
            const g =
              c.my[0] === 'left'
                ...
                : c.my[0] === 'right'
                  ? c.elemWidth
                  : 0;
            const h = c.at[0] === 'left' ? c.targetWidth : -c.targetWidth;
            const i = -2 * c.offset[0];
            b.left +=
            ...
            const g =
              c.my[1] === 'top'
                ...
                : c.my[1] === 'bottom'
                  ? c.elemHeight
                  : 0;
            const h = c.at[1] === 'top' ? c.targetHeight : -c.targetHeight;
            const i = -2 * c.offset[1];
            b.top +=
    ...
    a.offset.setOffset ||
      ((a.offset.setOffset = function (b, c) {
        ...
        const d = a(b);
        const e = d.offset();
        const f = parseInt(a.curCSS(b, 'top', !0), 10) || 0;
        const g = parseInt(a.curCSS(b, 'left', !0), 10) || 0;
        const h = { top: c.top - e.top + f, left: c.left - e.left + g };
    ...
    (function () {
      ...
      for (const j in g) d.style[j] = g[j];
      (d.appendChild(c),
 ...
 */ (function (a, b) {
  (a.widget('ui.droppable', {
    ...
    destroy() {
      const b = a.ui.ddmanager.droppables[this.options.scope];
      for (let c = 0; c < b.length; c++) b[c] == this && b.splice(c, 1);
      this.element
    ...
    _drop(b, c) {
      const d = c || a.ui.ddmanager.current;
    ...
    (a.ui.intersect = function (b, c, d) {
      ...
      const e = (b.positionAbs || b.position.absolute).left;
      const f = e + b.helperProportions.width;
      const g = (b.positionAbs || b.position.absolute).top;
      const h = g + b.helperProportions.height;
      const i = c.offset.left;
      const j = i + c.proportions.width;
      const k = c.offset.top;
      const l = k + c.proportions.height;
      switch (d) {
        case 'fit':
    ...
    (a.ui.ddmanager = {
      ...
      droppables: { default: [] },
      prepareOffsets(b, c) {
        const d = a.ui.ddmanager.droppables[b.options.scope] || [];
        const e = c ? c.type : null;
        const f = (b.currentItem || b.element)
          .find(':data(droppable)')
          .andSelf();
        droppablesLoop: for (let g = 0; g < d.length; g++) {
          if (
        ...
        (b.options.refreshPositions && a.ui.ddmanager.prepareOffsets(b, c),
          a.each(a.ui.ddmanager.droppables[b.options.scope] || [], function () {
            if (!(this.options.disabled || this.greedyChild || !this.visible)) {
              const d = a.ui.intersect(b, this, this.options.tolerance);
              const e =
                !d && this.isover == 1
                  ? 'isout'
                  : d && this.isover == 0
              ...
              if (this.options.greedy) {
                const g = this.element.parents(':data(droppable):eq(0)');
                g.length &&
  ...
  (a.widget('ui.resizable', a.ui.mouse, {
    ...
    _create() {
      ...
      if (this.handles.constructor == String) {
        ...
        const d = this.handles.split(',');
        this.handles = {};
        for (let e = 0; e < d.length; e++) {
          const f = a.trim(d[e]);
          const g = `ui-resizable-${f}`;
          const h = a(`<div class="ui-resizable-handle ${g}"></div>`);
          (/sw|se|ne|nw/.test(f) && h.css({ zIndex: ++c.zIndex }),
            f == 'se' && h.addClass('ui-icon ui-icon-gripsmall-diagonal-se'),
      ...
      ((this._renderAxis = function (b) {
        ...
        for (const c in this.handles) {
          ...
          if (
            ...
            const d = a(this.handles[c], this.element);
            let e = 0;
    ...
    _mouseStart(b) {
      ...
      ((this.resizing = !0),
        ...
        this._renderProxy());
      let g = c(this.helper.css('left'));
      let h = c(this.helper.css('top'));
      (d.containment &&
      ...
      const i = a(`.ui-resizable-${this.axis}`).css('cursor');
    ...
    _mouseDrag(b) {
      ...
      const e = {};
      const f = this;
      const g = this.originalMousePosition;
      const h = this.axis;
      const i = b.pageX - g.left || 0;
      const j = b.pageY - g.top || 0;
      const k = this._change[h];
      if (!k) return !1;
      let l = k.apply(this, [b, i, j]);
      const m = a.browser.msie && a.browser.version < 7;
      const n = this.sizeDiff;
    ...
    _mouseStop(b) {
      ...
      const d = this;
      if (this._helper) {
        const e = this._proportionallyResizeElements;
        const f = e.length && /textarea/i.test(e[0].nodeName);
        const g = f && a.ui.hasScroll(e[0], 'left') ? 0 : d.sizeDiff.height;
        const h = f ? 0 : d.sizeDiff.width;
        const i = {
    ...
    _respectSize(a, b) {
      ...
      const f = this._aspectRatio || b.shiftKey;
      const g = this.axis;
      const h = d(a.width) && e.maxWidth && e.maxWidth < a.width;
      const i = d(a.height) && e.maxHeight && e.maxHeight < a.height;
      const j = d(a.width) && e.minWidth && e.minWidth > a.width;
      const k = d(a.height) && e.minHeight && e.minHeight > a.height;
      (j && (a.width = e.minWidth),
        k && (a.height = e.minHeight),
        h && (a.width = e.maxWidth),
        i && (a.height = e.maxHeight));
      const l = this.originalPosition.left + this.originalSize.width;
      const m = this.position.top + this.size.height;
      const n = /sw|nw|w/.test(g);
      const o = /nw|ne|n/.test(g);
    ...
    _proportionallyResize() {
      ...
      if (this._proportionallyResizeElements.length) {
        const c = this.helper || this.element;
        for (let d = 0; d < this._proportionallyResizeElements.length; d++) {
          const e = this._proportionallyResizeElements[d];
          if (!this.borderDif) {
            const f = [
            ...
            this.borderDif = a.map(f, (a, b) => {
              const c = parseInt(a, 10) || 0;
              const d = parseInt(g[b], 10) || 0;
              return c + d;
            });
          }
          if (
    ...
    _renderProxy() {
      ...
      if (this._helper) {
        ...
        const d = a.browser.msie && a.browser.version < 7;
        const e = d ? 1 : 0;
        const f = d ? 2 : -1;
    ...
    _change: {
      ...
      w(a, b, c) {
        const d = this.options;
        const e = this.originalSize;
        const f = this.originalPosition;
    ...
    a.ui.plugin.add('resizable', 'alsoResize', {
      ...
      resize(b, c) {
        const d = a(this).data('resizable');
        const e = d.options;
        const f = d.originalSize;
        const g = d.originalPosition;
        const h = {
        ...
        const i = function (b, e) {
          a(b).each(function () {
            const b = a(this);
            const f = a(this).data('resizable-alsoresize');
            const g = {};
            const i =
              e && e.length
                ? e
    ...
    a.ui.plugin.add('resizable', 'animate', {
      stop(b, c) {
        const d = a(this).data('resizable');
        const e = d.options;
        const f = d._proportionallyResizeElements;
        const g = f.length && /textarea/i.test(f[0].nodeName);
        const h = g && a.ui.hasScroll(f[0], 'left') ? 0 : d.sizeDiff.height;
        const i = g ? 0 : d.sizeDiff.width;
        const j = { width: d.size.width - i, height: d.size.height - h };
        const k =
          parseInt(d.element.css('left'), 10) +
            (d.position.left - d.originalPosition.left) || null;
        const l =
    ...
    a.ui.plugin.add('resizable', 'containment', {
      start(b, d) {
        ...
        const f = e.options;
        const g = e.element;
        const h = f.containment;
        const i =
          h instanceof a ? h.get(0) : /parent/.test(h) ? g.parent().get(0) : h;
        if (i) {
          ...
          if (/document/.test(h) || h == document) {
            ...
            const j = a(i);
            const k = [];
            (a(['Top', 'Right', 'Left', 'Bottom']).each((a, b) => {
            ...
            const l = e.containerOffset;
            const m = e.containerSize.height;
            const n = e.containerSize.width;
            const o = a.ui.hasScroll(i, 'left') ? i.scrollWidth : n;
            const p = a.ui.hasScroll(i) ? i.scrollHeight : m;
            e.parentData = {
              element: i,
              left: l.left,
              top: l.top,
      ...
      resize(b, c) {
        const d = a(this).data('resizable');
        const e = d.options;
        const f = d.containerSize;
        const g = d.containerOffset;
        const h = d.size;
        const i = d.position;
        const j = d._aspectRatio || b.shiftKey;
        let k = { top: 0, left: 0 };
        const l = d.containerElement;
        ...
        const o = d.containerElement.get(0) == d.element.parent().get(0);
        const p = /relative|absolute/.test(d.containerElement.css('position'));
      ...
      stop(b, c) {
        ...
        const f = d.position;
        const g = d.containerOffset;
        const h = d.containerPosition;
        const i = d.containerElement;
        const j = a(d.helper);
        const k = j.offset();
        const l = j.outerWidth() - d.sizeDiff.width;
        const m = j.outerHeight() - d.sizeDiff.height;
        (d._helper &&
          !e.animate &&
    ...
    a.ui.plugin.add('resizable', 'grid', {
      resize(b, c) {
        ...
        const e = d.options;
        const f = d.size;
        const g = d.originalSize;
        const h = d.originalPosition;
        const i = d.axis;
        const j = e._aspectRatio || b.shiftKey;
      ...
      if (!this.options.disabled) {
        ...
        ((this.selectees = a(d.filter, this.element[0])),
          ...
          this.selectees.filter('.ui-selected').each(function () {
            const d = a.data(this, 'selectable-item');
            ((d.startselected = !0),
              !b.metaKey &&
                !b.ctrlKey &&
      ...
      if (!this.options.disabled) {
        ...
        (this.helper.css({
          ...
          this.selectees.each(function () {
            const i = a.data(this, 'selectable-item');
  ...
  (a.widget('ui.sortable', a.ui.mouse, {
    ...
    destroy() {
      (this.element.removeClass('ui-sortable ui-sortable-disabled'),
        this._mouseDestroy());
      for (let a = this.items.length - 1; a >= 0; a--)
    ...
    _mouseStart(b, c, d) {
      ...
      if (!d)
        for (let g = this.containers.length - 1; g >= 0; g--)
    ...
    _mouseDrag(b) {
      ...
      for (let e = this.items.length - 1; e >= 0; e--) {
        const f = this.items[e];
        const g = f.item[0];
        const h = this._intersectsWithPointer(f);
        if (!h) continue;
        if (
    ...
    serialize(b) {
      const c = this._getItemsAsjQuery(b && b.connected);
      const d = [];
      ((b = b || {}),
        a(c).each(function () {
          const c = (a(b.item || this).attr(b.attribute || 'id') || '').match(
            b.expression || /(.+)[-=_](.+)/,
          );
          c &&
            d.push(
    ...
    _intersectsWith(a) {
      const b = this.positionAbs.left;
      const c = b + this.helperProportions.width;
      const d = this.positionAbs.top;
      const e = d + this.helperProportions.height;
      const f = a.left;
      const g = f + a.width;
      const h = a.top;
      const i = h + a.height;
      const j = this.offset.click.top;
      const k = this.offset.click.left;
      const l = d + j > h && d + j < i && b + k > f && b + k < g;
    ...
    _intersectsWithPointer(b) {
      ...
      const g = this._getDragHorizontalDirection();
      if (!e) return !1;
    ...
    _intersectsWithSides(b) {
      ...
      const e = this._getDragVerticalDirection();
    ...
    _getDragVerticalDirection() {
      const a = this.positionAbs.top - this.lastPositionAbs.top;
      return a != 0 && (a > 0 ? 'down' : 'up');
    },
    _getDragHorizontalDirection() {
      const a = this.positionAbs.left - this.lastPositionAbs.left;
    ...
    _getItemsAsjQuery(b) {
      ...
      const d = [];
      const e = [];
      const f = this._connectWith();
      if (f && b)
        for (var g = f.length - 1; g >= 0; g--) {
          const h = a(f[g]);
          for (let i = h.length - 1; i >= 0; i--) {
            const j = a.data(h[i], this.widgetName);
            j &&
              j != this &&
              !j.options.disabled &&
              e.push([
    ...
    _removeCurrentsFromItems() {
      const a = this.currentItem.find(`:data(${this.widgetName}-item)`);
    ...
    refreshPositions(b) {
      ...
      for (var c = this.items.length - 1; c >= 0; c--) {
        ...
        if (
          ...
          continue;
        const e = this.options.toleranceElement
    ...
    _createPlaceholder(b) {
      const c = b || this;
      const d = c.options;
      if (!d.placeholder || d.placeholder.constructor == String) {
        const e = d.placeholder;
        d.placeholder = {
          element() {
            const b = a(document.createElement(c.currentItem[0].nodeName))
              .addClass(
    ...
    _getRelativeOffset() {
      if (this.cssPosition == 'relative') {
        const a = this.currentItem.position();
        return {
          top:
            a.top -
            (parseInt(this.helper.css('top'), 10) || 0) +
    ...
    _setContainment() {
      ...
      if (!/^(document|window|parent)$/.test(b.containment)) {
        const c = a(b.containment)[0];
        const d = a(b.containment).offset();
        const e = a(c).css('overflow') != 'hidden';
        this.containment = [
          d.left +
 ...
 */ (function (a, b) {
  (a.widget('ui.accordion', {
    ...
    _create() {
      ...
      if (c.navigation) {
        const d = b.element.find('a').filter(c.navigationFilter).eq(0);
        if (d.length) {
          const e = d.closest('.ui-accordion-header');
          e.length
            ? (b.active = e)
      ...
      ((b.active = b
        ...
        b.headers
          .attr('role', 'tab')
          .bind('keydown.accordion', (a) => b._keydown(a))
          .next()
          .attr('role', 'tabpanel'),
        b.headers
          .not(b.active || '')
    ...
    _keydown(b) {
      if (!(this.options.disabled || b.altKey || b.ctrlKey)) {
        ...
        const d = this.headers.length;
        const e = this.headers.index(b.target);
        let f = !1;
        switch (b.keyCode) {
          case c.RIGHT:
          case c.DOWN:
    ...
    _clickHandler(b, c) {
      ...
      if (!d.disabled) {
        ...
        const h = a(b.currentTarget || c);
        const i = h[0] === this.active[0];
        ...
        const k = this.headers.index(this.active[0]) > this.headers.index(h[0]);
        ((this.active = i ? a([]) : h),
      ...
      if (h.animated) {
        ...
        (h.collapsible && e
          ...
          (h.duration = a.isFunction(h.proxiedDuration)
            ? h.proxiedDuration(j)
            : h.proxiedDuration));
        const k = a.ui.accordion.animations;
        const l = h.duration;
        let m = h.animated;
        ...
        slide(b, c) {
          ...
          if (!b.toHide.size())
            ...
            ((i = j[0].style.width),
              ...
              a.each(h, (c, d) => {
                g[d] = 'hide';
                const e = `${a.css(b.toShow[0], d)}`.match(/^([\d+-.]+)(.*)$/);
 ...
 */ ((function (a, b) {
  ...
  (a.widget('ui.autocomplete', {
    ...
    _create() {
      const b = this;
      const c = this.element[0].ownerDocument;
      let d;
      (this.element
    ...
    _suggest(b) {
      const c = this.menu.element.empty().zIndex(this.element.zIndex() + 1);
    ...
    a.extend(a.ui.autocomplete, {
      ...
      filter(b, c) {
        const d = new RegExp(a.ui.autocomplete.escapeRegex(c), 'i');
        return a.grep(b, (a) => d.test(a.label || a.value || a));
      },
    }));
})(jQuery),
  (function (a) {
    a.widget('ui.menu', {
      ...
      activate(a, b) {
        this.deactivate();
        if (this.hasScroll()) {
          const c = b.offset().top - this.element.offset().top;
          const d = this.element.scrollTop();
      ...
      move(a, b, c) {
        if (!this.active) this.activate(c, this.element.children(b));
          ...
          const d = this.active[`${a}All`]('.ui-menu-item').eq(0);
          d.length
            ? this.activate(c, d)
      ...
      nextPage(b) {
        if (this.hasScroll()) {
          ...
          const d = this.element.height();
          let e = this.element.children('.ui-menu-item').filter(function () {
            const b = a(this).offset().top - c - d + a(this).height();
            return b < 10 && b > -10;
          });
 ...
 */ (function (a, b) {
  ...
  let e;
  let f;
  const g = 'ui-button ui-widget ui-state-default ui-corner-all';
  const h = 'ui-state-hover ui-state-active ';
  const i =
    'ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only';
  const j = function () {
    const b = a(this).find(':ui-button');
    setTimeout(() => {
      b.button('refresh');
    }, 1);
  };
  ...
  (a.widget('ui.button', {
    ...
    _create() {
      ...
      const i = this.type === 'checkbox' || this.type === 'radio';
      const l = `ui-state-hover${i ? '' : ' ui-state-active'}`;
      const m = 'ui-state-focus';
      (h.label === null && (h.label = this.buttonElement.html()),
        ...
        i &&
          ...
          this.buttonElement
            .bind('mousedown.button', (a) => {
              h.disabled || ((f = !1), (d = a.pageX), (e = a.pageY));
            })
            .bind('mouseup.button', (a) => {
    ...
    _determineButtonType() {
      ...
      if (this.type === 'checkbox' || this.type === 'radio') {
        let a = this.element.parents().filter(':last');
        const b = `label[for='${this.element.attr('id')}']`;
        ...
        const c = this.element.is(':checked');
    ...
    refresh() {
      const b = this.element.is(':disabled');
    ...
    _resetButton() {
      if (this.type === 'input')
        ...
        const b = this.buttonElement.removeClass(i);
        const c = a('<span></span>', this.element[0].ownerDocument)
          .addClass('ui-button-text')
          .html(this.options.label)
          .appendTo(b.empty())
          .text();
        const d = this.options.icons;
        const e = d.primary && d.secondary;
        const f = [];
        (d.primary || d.secondary
          ? (this.options.text &&
            ...
            d.secondary &&
              b.append(
                `<span class='ui-button-icon-secondary ui-icon ${d.secondary}'></span>`,
              ),
            this.options.text ||
    ...
    a.widget('ui.buttonset', {
      ...
      refresh() {
        const b = this.element.css('direction') === 'rtl';
 ...
 */ (function (a, b) {
  const c = 'ui-dialog ui-widget ui-widget-content ui-corner-all ';
  const d = {
    buttons: !0,
    height: !0,
    maxHeight: !0,
  ...
  (a.widget('ui.dialog', {
    options: {
      ...
      position: {
        ...
        collision: 'fit',
        using(b) {
          const c = a(this).css(b).offset().top;
    ...
    _create() {
      ...
      const d = b.options;
      const e = d.title || '&#160;';
      const f = a.ui.dialog.getTitleId(b.element);
      const g = (b.uiDialog = a('<div></div>'))
      ...
      const h = b.element
        ...
        .appendTo(g);
      const i = (b.uiDialogTitlebar = a('<div></div>'))
        .addClass(
      ...
      var j = a('<a href="#"></a>')
        ...
        .appendTo(i);
      const k = (b.uiDialogTitlebarCloseText = a('<span></span>'))
          ...
          c.modal &&
            d.bind('keydown.ui-dialog', function (b) {
              if (b.keyCode === a.ui.keyCode.TAB) {
                const c = a(':tabbable', this);
                const d = c.filter(':first');
                const e = c.filter(':last');
    ...
    _createButtons(b) {
      const c = this;
      let d = !1;
      const e = a('<div></div>').addClass(
        'ui-dialog-buttonpane ui-widget-content ui-helper-clearfix',
      );
      const g = a('<div></div>').addClass('ui-dialog-buttonset').appendTo(e);
      (c.uiDialog.find('.ui-dialog-buttonpane').remove(),
        typeof b === 'object' && b !== null && a.each(b, () => !(d = !0)),
        d &&
          (a.each(b, (b, d) => {
            d = a.isFunction(d) ? { click: d, text: b } : d;
            const e = a('<button type="button"></button>')
              .click(function () {
    ...
    _makeResizable(c) {
      ...
      const d = this;
      const e = d.options;
      const f = d.uiDialog.css('position');
      const g = typeof c === 'string' ? c : 'n,e,s,w,se,sw,ne,nw';
      d.uiDialog
        .resizable({
    ...
    _size() {
      ...
      if (b.height === 'auto')
        if (a.support.minHeight)
          ...
          this.uiDialog.show();
          const f = this.element.css('height', 'auto').height();
    ...
    a.extend(a.ui.dialog.overlay, {
      ...
      create(b) {
        this.instances.length === 0 &&
          ...
          a(document).bind('keydown.dialog-overlay', (c) => {
      ...
      destroy(b) {
        const c = a.inArray(b, this.instances);
      ...
      ((this._keySliding = !1),
        ...
        d.range &&
          ...
          (this.range = a('<div></div>')
            ...
            .addClass(
              `ui-slider-range ui-widget-header${d.range === 'min' || d.range === 'max' ? ` ui-slider-range-${d.range}` : ''}`,
            ))));
  ...
  (a.widget('ui.tabs', {
    ...
    _tabify(c) {
        ...
        c
          ? (this.element.addClass(
            ...
            (e.disabled = a
              .unique(
                e.disabled.concat(
                  a.map(this.lis.filter('.ui-state-disabled'), (a, b) =>
                    d.lis.index(a),
                  ),
                ),
              )
      ...
      (this.anchors.bind(`${e.event}.tabs`, function () {
        const b = this;
        const c = a(b).closest('li');
        const f = d.panels.filter(':not(.ui-tabs-hide)');
        const g = d.element.find(d._sanitizeSelector(b.hash));
        if (
    ...
    destroy() {
      ...
      (this.abort(),
        ...
        this.anchors.each(function () {
          ...
          b && (this.href = b);
          const c = a(this).unbind('.tabs');
          a.each(['href', 'load', 'cache'], (a, b) => {
            c.removeData(`${b}.tabs`);
          });
        }),
        this.lis
    ...
    add(c, d, e) {
      ...
      const i = c.indexOf('#') ? this._tabId(a('a', h)[0]) : c.replace('#', '');
      h.addClass('ui-state-default ui-corner-top').data('destroy.tabs', !0);
      let j = f.element.find(`#${i}`);
      (j.length ||
        ...
        (g.disabled = a.map(g.disabled, (a, b) => (a >= e ? ++a : a))),
        this._tabify(),
    ...
    remove(b) {
      b = this._getIndex(b);
      const c = this.options;
      const d = this.lis.eq(b).remove();
      const e = this.panels.eq(b).remove();
      (d.hasClass('ui-tabs-selected') &&
        this.anchors.length > 1 &&
        this.select(b + (b + 1 < this.anchors.length ? 1 : -1)),
        (c.disabled = a.map(
          a.grep(c.disabled, (a, c) => a != b),
          (a, c) => (a >= b ? --a : a),
        )),
        this._tabify(),
    ...
    enable(b) {
      ...
      if (a.inArray(b, c.disabled) != -1) {
        (this.lis.eq(b).removeClass('ui-state-disabled'),
          (c.disabled = a.grep(c.disabled, (a, c) => a != b)),
          this._trigger(
            'enable',
            null,
    ...
    load(b) {
      ...
      const c = this;
      const d = this.options;
      const e = this.anchors.eq(b)[0];
      const f = a.data(e, 'load.tabs');
      this.abort();
      if (
        !f ||
 ...
 */ (function ($, undefined) {
  ...
  function extendRemove(a, b) {
    $.extend(a, b);
    for (const c in b) if (b[c] == null || b[c] == undefined) a[c] = b[c];
    return a;
  }
  ...
  ($.extend(Datepicker.prototype, {
    ...
    _newInst(a, b) {
      const c = a[0].id.replace(/([^A-Za-z0-9_-])/g, '\\\\$1');
      return {
        id: c,
        input: a,
        selectedDay: 0,
    ...
    _attachments(a, b) {
      const c = this._get(b, 'appendText');
      const d = this._get(b, 'isRTL');
      ...
      const e = this._get(b, 'showOn');
      (e == 'focus' || e == 'both') && a.focus(this._showDatepicker);
      if (e == 'button' || e == 'both') {
        const f = this._get(b, 'buttonText');
        const g = this._get(b, 'buttonImage');
        ((b.trigger = $(
    ...
    _dialogDatepicker(a, b, c, d, e) {
      let f = this._dialogInst;
      if (!f) {
        this.uuid += 1;
        const g = `dp${this.uuid}`;
        ((this._dialogInput = $(
      ...
      if (!this._pos) {
        ...
        const k = document.documentElement.scrollTop || document.body.scrollTop;
    ...
    _enableDatepicker(a) {
      ...
      if (b.hasClass(this.markerClassName)) {
        ...
        if (d == 'input') {
          ...
          const e = b.children(`.${this._inlineClass}`);
          (e.children().removeClass('ui-state-disabled'),
            e
              .find('select.ui-datepicker-month, select.ui-datepicker-year')
              .removeAttr('disabled'));
        }
        this._disabledInputs = $.map(this._disabledInputs, (b) =>
          b == a ? null : b,
        );
      }
    },
    ...
    _isDisabledDatepicker(a) {
      if (!a) return !1;
      for (let b = 0; b < this._disabledInputs.length; b++)
    ...
    _optionDatepicker(a, b, c) {
      ...
      if (d) {
        ...
        const f = this._getDateDatepicker(a, !0);
        const g = this._getMinMaxDate(d, 'min');
        const h = this._getMinMaxDate(d, 'max');
    ...
    _refreshDatepicker(a) {
      const b = this._getInst(a);
      b && this._updateDatepicker(b);
    },
    _setDateDatepicker(a, b) {
      const c = this._getInst(a);
      c &&
        (this._setDate(c, b),
    ...
    _doKeyDown(a) {
      const b = $.datepicker._getInst(a.target);
      let c = !0;
      const d = b.dpDiv.is('.ui-datepicker-rtl');
      b._keyEvent = !0;
      if ($.datepicker._datepickerShowing)
        switch (a.keyCode) {
          ...
          case 13:
            ...
            if (f) {
              const g = $.datepicker._formatDate(b);
    ...
    _doKeyPress(a) {
      ...
      if ($.datepicker._get(b, 'constrainInput')) {
        const c = $.datepicker._possibleChars(
    ...
    _showDatepicker(a) {
      ...
      if (
        ...
        const c = $.datepicker._get(b, 'beforeShow');
        const d = c ? c.apply(a, [a, b]) : {};
        if (d === !1) return;
        ...
        let f = { left: $.datepicker._pos[0], top: $.datepicker._pos[1] };
        ...
        if (!b.inline) {
          const g = $.datepicker._get(b, 'showAnim');
          const h = $.datepicker._get(b, 'duration');
          const i = function () {
            const a = b.dpDiv.find('iframe.ui-datepicker-cover');
            if (a.length) {
              const c = $.datepicker._getBorders(b.dpDiv);
              a.css({
                left: -c[0],
                top: -c[1],
    ...
    _updateDatepicker(a) {
      const b = this;
      b.maxRows = 4;
      const c = $.datepicker._getBorders(a.dpDiv);
      ((instActive = a), a.dpDiv.empty().append(this._generateHTML(a)));
      const d = a.dpDiv.find('iframe.ui-datepicker-cover');
      (!d.length ||
        d.css({
          left: -c[0],
          top: -c[1],
      ...
      const e = this._getNumberOfMonths(a);
      const f = e[1];
      const g = 17;
      (a.dpDiv
        .removeClass(
    ...
    _checkOffset(a, b, c) {
      const d = a.dpDiv.outerWidth();
      const e = a.dpDiv.outerHeight();
      const f = a.input ? a.input.outerWidth() : 0;
      const g = a.input ? a.input.outerHeight() : 0;
      const h = document.documentElement.clientWidth + $(document).scrollLeft();
      const i = document.documentElement.clientHeight + $(document).scrollTop();
    ...
    _hideDatepicker(a) {
      const b = this._curInst;
      if (
        !(!b || (a && b != $.data(a, PROP_NAME))) &&
        this._datepickerShowing
      ) {
        const c = this._get(b, 'showAnim');
        const d = this._get(b, 'duration');
        const e = this;
        const f = function () {
    ...
    _checkExternalClick(a) {
      if ($.datepicker._curInst) {
        const b = $(a.target);
        const c = $.datepicker._getInst(b[0]);
    ...
    _selectDate(a, b) {
      const c = $(a);
      const d = this._getInst(c[0]);
      ((b = b != null ? b : this._formatDate(d)),
        d.input && d.input.val(b),
        this._updateAlternate(d));
      const e = this._get(d, 'onSelect');
      (e
    ...
    _updateAlternate(a) {
      const b = this._get(a, 'altField');
      if (b) {
        const c = this._get(a, 'altFormat') || this._get(a, 'dateFormat');
        const d = this._getDate(a);
        const e = this.formatDate(c, d, this._getFormatConfig(a));
        $(b).each(function () {
          $(this).val(e);
        });
      }
    ...
    parseDate(a, b, c) {
      ...
      if (b == '') return null;
      let d = (c ? c.shortYearCutoff : null) || this._defaults.shortYearCutoff;
      d =
        typeof d !== 'string'
          ? d
          : (new Date().getFullYear() % 100) + parseInt(d, 10);
      const e = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort;
      const f = (c ? c.dayNames : null) || this._defaults.dayNames;
      const g =
        (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort;
      const h = (c ? c.monthNames : null) || this._defaults.monthNames;
      let i = -1;
      let j = -1;
      let k = -1;
      let l = -1;
      let m = !1;
      const n = function (b) {
        const c = s + 1 < a.length && a.charAt(s + 1) == b;
        c && s++;
        return c;
      };
      const o = function (a) {
        const c = n(a);
        const d =
          a == '@' ? 14 : a == '!' ? 20 : a == 'y' && c ? 4 : a == 'o' ? 3 : 2;
        const e = new RegExp(`^\\d{1,${d}}`);
        const f = b.substring(r).match(e);
        if (!f) throw `Missing number at position ${r}`;
        r += f[0].length;
        return parseInt(f[0], 10);
      };
      const p = function (a, c, d) {
        const e = $.map(n(a) ? d : c, (a, b) => [[b, a]]).sort(
      ...
      if (l > -1) {
        ((j = 1), (k = l));
        for (;;) {
          const u = this._getDaysInMonth(i, j - 1);
          if (k <= u) break;
          (j++, (k -= u));
        }
      }
    ...
    formatDate(a, b, c) {
      if (!b) return '';
      const d = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort;
      const e = (c ? c.dayNames : null) || this._defaults.dayNames;
      const f =
        (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort;
      const g = (c ? c.monthNames : null) || this._defaults.monthNames;
      const h = function (b) {
        const c = m + 1 < a.length && a.charAt(m + 1) == b;
        c && m++;
        return c;
      };
    ...
    _possibleChars(a) {
      ...
      let c = !1;
      const d = function (b) {
        const c = e + 1 < a.length && a.charAt(e + 1) == b;
        c && e++;
        return c;
      };
    ...
    _setDateFromField(a, b) {
      if (a.input.val() != a.lastVal) {
        const c = this._get(a, 'dateFormat');
        let d = (a.lastVal = a.input ? a.input.val() : null);
        let e;
        let f;
        e = f = this._getDefaultDate(a);
        const g = this._getFormatConfig(a);
        try {
    ...
    _determineDate(a, b, c) {
      ...
      const e = function (b) {
        ...
        let f = d.getMonth();
        let g = d.getDate();
        const h = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g;
        let i = h.exec(b);
        while (i) {
          switch (i[2] || 'd') {
            case 'd':
    ...
    _setDate(a, b, c) {
      const d = !b;
      const e = a.selectedMonth;
      const f = a.selectedYear;
      const g = this._restrictMinMax(a, this._determineDate(a, b, new Date()));
    ...
    _generateHTML(a) {
      ...
      const c = this._get(a, 'isRTL');
      const d = this._get(a, 'showButtonPanel');
      const e = this._get(a, 'hideIfNoPrevNext');
      const f = this._get(a, 'navigationAsDateFormat');
      const g = this._getNumberOfMonths(a);
      const h = this._get(a, 'showCurrentAtPos');
      const i = this._get(a, 'stepMonths');
      const j = g[0] != 1 || g[1] != 1;
      const k = this._daylightSavingAdjust(
        a.currentDay
          ? new Date(a.currentYear, a.currentMonth, a.currentDay)
          : new Date(9999, 9, 9),
      );
      const l = this._getMinMaxDate(a, 'min');
      const m = this._getMinMaxDate(a, 'max');
      let n = a.drawMonth - h;
      let o = a.drawYear;
      n < 0 && ((n += 12), o--);
      if (m) {
        let p = this._daylightSavingAdjust(
          new Date(
            m.getFullYear(),
      ...
      q = f
        ...
        : q;
      const r = this._canAdjustMonth(a, -1, o, n)
        ? `<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_${dpuuid}.datepicker._adjustDate('#${a.id}', -${i}, 'M');"` +
          ` title="${q}"><span class="ui-icon ui-icon-circle-triangle-${c ? 'e' : 'w'}">${q}</span></a>`
        : e
          ? ''
      ...
      s = f
        ...
        : s;
      const t = this._canAdjustMonth(a, 1, o, n)
        ? `<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_${dpuuid}.datepicker._adjustDate('#${a.id}', +${i}, 'M');"` +
          ` title="${s}"><span class="ui-icon ui-icon-circle-triangle-${c ? 'w' : 'e'}">${s}</span></a>`
        : e
          ? ''
      ...
      let u = this._get(a, 'currentText');
      const v = this._get(a, 'gotoCurrent') && a.currentDay ? k : b;
      u = f ? this.formatDate(u, v, this._getFormatConfig(a)) : u;
      const w = a.inline
        ? ''
        : `<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_${dpuuid}.datepicker._hideDatepicker();">${this._get(a, 'closeText')}</button>`;
      const x = d
        ? `<div class="ui-datepicker-buttonpane ui-widget-content">${c ? w : ''}${this._isInRange(a, v) ? `<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_${dpuuid}.datepicker._gotoToday('#${a.id}');"` + `>${u}</button>` : ''}${c ? '' : w}</div>`
        : '';
      let y = parseInt(this._get(a, 'firstDay'), 10);
      y = isNaN(y) ? 0 : y;
      const z = this._get(a, 'showWeek');
      const A = this._get(a, 'dayNames');
      const B = this._get(a, 'dayNamesShort');
      const C = this._get(a, 'dayNamesMin');
      const D = this._get(a, 'monthNames');
      const E = this._get(a, 'monthNamesShort');
      const F = this._get(a, 'beforeShowDay');
      const G = this._get(a, 'showOtherMonths');
      const H = this._get(a, 'selectOtherMonths');
      const I = this._get(a, 'calculateWeek') || this.iso8601Week;
      const J = this._getDefaultDate(a);
      let K = '';
      for (let L = 0; L < g[0]; L++) {
        let M = '';
        this.maxRows = 4;
        for (let N = 0; N < g[1]; N++) {
          const O = this._daylightSavingAdjust(new Date(o, n, a.selectedDay));
          let P = ' ui-corner-all';
          let Q = '';
          if (j) {
          ...
          Q +=
            `<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix${P}">${/all|left/.test(P) && L == 0 ? (c ? t : r) : ''}${/all|right/.test(P) && L == 0 ? (c ? r : t) : ''}${this._generateMonthYearHeader(a, n, o, l, m, L > 0 || N > 0, D, E)}</div><table class="ui-datepicker-calendar"><thead>` +
            '<tr>';
          let R = z
          ...
          for (var S = 0; S < 7; S++) {
            const T = (S + y) % 7;
            R +=
              `<th${(S + y + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : ''}>` +
              `<span title="${A[T]}">${C[T]}</span></th>`;
          }
          Q += `${R}</tr></thead><tbody>`;
          const U = this._getDaysInMonth(o, n);
          o == a.selectedYear &&
            n == a.selectedMonth &&
            (a.selectedDay = Math.min(a.selectedDay, U));
          const V = (this._getFirstDayOfMonth(o, n) - y + 7) % 7;
          const W = Math.ceil((V + U) / 7);
          const X = j ? (this.maxRows > W ? this.maxRows : W) : W;
          this.maxRows = X;
          let Y = this._daylightSavingAdjust(new Date(o, n, 1 - V));
          for (let Z = 0; Z < X; Z++) {
            Q += '<tr>';
            let _ = z
            ...
            for (var S = 0; S < 7; S++) {
              const ba = F
                ...
                : [!0, ''];
              const bb = Y.getMonth() != n;
              const bc = (bb && !H) || !ba[0] || (l && Y < l) || (m && Y > m);
    ...
    _generateMonthYearHeader(a, b, c, d, e, f, g, h) {
      const i = this._get(a, 'changeMonth');
      const j = this._get(a, 'changeYear');
      const k = this._get(a, 'showMonthAfterYear');
      let l = '<div class="ui-datepicker-title">';
      let m = '';
      if (f || !i) m += `<span class="ui-datepicker-month">${g[b]}</span>`;
      else {
        const n = d && d.getFullYear() == c;
        const o = e && e.getFullYear() == c;
        m +=
          `<select class="ui-datepicker-month" onchange="DP_jQuery_${dpuuid}.datepicker._selectMonthYear('#${a.id}', this, 'M');" ` +
          '>';
        for (let p = 0; p < 12; p++)
          (!n || p >= d.getMonth()) &&
            (!o || p <= e.getMonth()) &&
      ...
      if (!a.yearshtml) {
        ...
        if (f || !j) l += `<span class="ui-datepicker-year">${c}</span>`;
          ...
          const q = this._get(a, 'yearRange').split(':');
          ...
          let t = s(q[0]);
          let u = Math.max(t, s(q[1] || ''));
          ((t = d ? Math.max(t, d.getFullYear()) : t),
            (u = e ? Math.min(u, e.getFullYear()) : u),
            (a.yearshtml +=
              `<select class="ui-datepicker-year" onchange="DP_jQuery_${dpuuid}.datepicker._selectMonthYear('#${a.id}', this, 'Y');" ` +
              '>'));
          for (; t <= u; t++)
    ...
    _adjustInstDate(a, b, c) {
      const d = a.drawYear + (c == 'Y' ? b : 0);
      const e = a.drawMonth + (c == 'M' ? b : 0);
      const f =
        Math.min(a.selectedDay, this._getDaysInMonth(d, e)) +
        (c == 'D' ? b : 0);
      const g = this._restrictMinMax(
        a,
    ...
    _restrictMinMax(a, b) {
      const c = this._getMinMaxDate(a, 'min');
      const d = this._getMinMaxDate(a, 'max');
      let e = c && b < c ? c : b;
      e = d && e > d ? d : e;
      return e;
    },
    _notifyChange(a) {
      const b = this._get(a, 'onChangeMonthYear');
      b &&
    ...
    _getNumberOfMonths(a) {
      const b = this._get(a, 'numberOfMonths');
    ...
    _getFirstDayOfMonth(a, b) {
      return new Date(a, b, 1).getDay();
    },
    _canAdjustMonth(a, b, c, d) {
      const e = this._getNumberOfMonths(a);
      const f = this._daylightSavingAdjust(
    ...
    _getFormatConfig(a) {
      let b = this._get(a, 'shortYearCutoff');
      b =
        typeof b !== 'string'
          ? b
  ...
  (function (a, b) {
    ...
    function h() {
      ...
      if (a && a.length && a[0] && a[a[0]]) {
        ...
        while (e--)
          ((c = a[e]),
            typeof a[c] === 'string' &&
              ((d = c.replace(/\-(\w)/g, (a, b) => b.toUpperCase())),
              (b[d] = a[c])));
    ...
    ((a.effects.animateClass = function (b, c, d, e) {
      ...
      return this.queue(function () {
        const g = a(this);
        const k = g.attr('style') || ' ';
        const l = i(h.call(this));
        let m;
        const n = g.attr('class');
        (a.each(f, (a, c) => {
          b[c] && g[`${c}Class`](b[c]);
        }),
          (m = i(h.call(this))),
      ...
      a.extend(a.effects, {
        ...
        createWrapper(b) {
          ...
          let d = a('<div></div>').addClass('ui-effects-wrapper').css({
            fontSize: '100%',
          ...
          (b.wrap(d),
            ...
            b.css('position') == 'static'
              ...
              : (a.extend(c, {
                ...
                a.each(['top', 'left', 'bottom', 'right'], (a, d) => {
                  ((c[d] = b.css(d)),
      ...
      a.fn.extend({
        effect(b, c, d, e) {
          const f = k.apply(this, arguments);
          const g = { options: f[1], duration: f[2], callback: f[3] };
          const h = g.options.mode;
          const i = a.effects[b];
          if (a.fx.off || !i)
            return h
        ...
        show(a) {
          ...
          const b = k.apply(this, arguments);
          b[1].mode = 'show';
        ...
        toggle(b) {
          ...
          const c = k.apply(this, arguments);
          c[1].mode = 'toggle';
      ...
      a.extend(a.easing, {
        ...
        easeInExpo(a, b, c, d, e) {
          return b == 0 ? c : d * 2 ** (10 * (b / e - 1)) + c;
        },
        easeOutExpo(a, b, c, d, e) {
          return b == e ? c + d : d * (-(2 ** ((-10 * b) / e)) + 1) + c;
        },
        easeInOutExpo(a, b, c, d, e) {
          if (b == 0) return c;
          if (b == e) return c + d;
          if ((b /= e / 2) < 1) return (d / 2) * 2 ** (10 * (b - 1)) + c;
          return (d / 2) * (-(2 ** (-10 * --b)) + 2) + c;
        },
        ...
        easeOutElastic(a, b, c, d, e) {
          ...
          return (
            h * 2 ** (-10 * b) * Math.sin(((b * e - f) * 2 * Math.PI) / g) +
            d +
            c
          );
        },
        ...
        easeInBack(a, c, d, e, f, g) {
          g == b && (g = 1.70158);
          return e * (c /= f) * c * ((g + 1) * c - g) + d;
        },
        easeOutBack(a, c, d, e, f, g) {
          g == b && (g = 1.70158);
          return e * ((c = c / f - 1) * c * ((g + 1) * c + g) + 1) + d;
        },
        easeInOutBack(a, c, d, e, f, g) {
          g == b && (g = 1.70158);
          if ((c /= f / 2) < 1)
 ...
 */ (function (a, b) {
  a.effects.blind = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = ['position', 'top', 'bottom', 'left', 'right'];
      const e = a.effects.setMode(c, b.options.mode || 'hide');
      const f = b.options.direction || 'vertical';
      (a.effects.save(c, d), c.show());
      const g = a.effects.createWrapper(c).css({ overflow: 'hidden' });
      const h = f == 'vertical' ? 'height' : 'width';
      const i = f == 'vertical' ? g.height() : g.width();
      e == 'show' && g.css(h, 0);
      const j = {};
      ((j[h] = e == 'show' ? i : 0),
 ...
 */ (function (a, b) {
  a.effects.bounce = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = ['position', 'top', 'bottom', 'left', 'right'];
      const e = a.effects.setMode(c, b.options.mode || 'effect');
      const f = b.options.direction || 'up';
      var g = b.options.distance || 20;
      let h = b.options.times || 5;
      const i = b.duration || 250;
      (/show|hide/.test(e) && d.push('opacity'),
        a.effects.save(c, d),
        c.show(),
        a.effects.createWrapper(c));
      const j = f == 'up' || f == 'down' ? 'top' : 'left';
      const k = f == 'up' || f == 'left' ? 'pos' : 'neg';
      var g =
        b.options.distance ||
        (j == 'top'
 ...
 */ (function (a, b) {
  a.effects.clip = function (b) {
    return this.queue(function () {
      ...
      (a.effects.save(c, d), c.show());
      const g = a.effects.createWrapper(c).css({ overflow: 'hidden' });
      const h = c[0].tagName == 'IMG' ? g : c;
      const i = {
        size: f == 'vertical' ? 'height' : 'width',
        position: f == 'vertical' ? 'top' : 'left',
      };
      const j = f == 'vertical' ? h.height() : h.width();
 ...
 */ (function (a, b) {
  a.effects.drop = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = ['position', 'top', 'bottom', 'left', 'right', 'opacity'];
      const e = a.effects.setMode(c, b.options.mode || 'hide');
      const f = b.options.direction || 'left';
      (a.effects.save(c, d), c.show(), a.effects.createWrapper(c));
      const g = f == 'up' || f == 'down' ? 'top' : 'left';
      const h = f == 'up' || f == 'left' ? 'pos' : 'neg';
      const i =
        b.options.distance ||
        (g == 'top'
 ...
 */ (function (a, b) {
  a.effects.explode = function (b) {
    return this.queue(function () {
      const c = b.options.pieces ? Math.round(Math.sqrt(b.options.pieces)) : 3;
      const d = b.options.pieces ? Math.round(Math.sqrt(b.options.pieces)) : 3;
      b.options.mode =
        b.options.mode == 'toggle'
          ? a(this).is(':visible')
            ...
            : 'show'
          : b.options.mode;
      const e = a(this).show().css('visibility', 'hidden');
      const f = e.offset();
      ((f.top -= parseInt(e.css('marginTop'), 10) || 0),
        (f.left -= parseInt(e.css('marginLeft'), 10) || 0));
      const g = e.outerWidth(!0);
      const h = e.outerHeight(!0);
      for (let i = 0; i < c; i++) {
        for (let j = 0; j < d; j++) {
          e.clone()
            .appendTo('body')
 ...
 */ (function (a, b) {
  a.effects.fade = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = a.effects.setMode(c, b.options.mode || 'hide');
      c.animate(
        { opacity: d },
        {
          queue: !1,
 ...
 */ (function (a, b) {
  a.effects.fold = function (b) {
    return this.queue(function () {
      ...
      const d = ['position', 'top', 'bottom', 'left', 'right'];
      const e = a.effects.setMode(c, b.options.mode || 'hide');
      let f = b.options.size || 15;
      const g = !!b.options.horizFirst;
      const h = b.duration ? b.duration / 2 : a.fx.speeds._default / 2;
      (a.effects.save(c, d), c.show());
      const i = a.effects.createWrapper(c).css({ overflow: 'hidden' });
      const j = (e == 'show') != g;
      const k = j ? ['width', 'height'] : ['height', 'width'];
      const l = j ? [i.width(), i.height()] : [i.height(), i.width()];
      const m = /([0-9]+)%/.exec(f);
 ...
 */ (function (a, b) {
  a.effects.highlight = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = ['backgroundImage', 'backgroundColor', 'opacity'];
      const e = a.effects.setMode(c, b.options.mode || 'show');
      const f = { backgroundColor: c.css('backgroundColor') };
      (e == 'hide' && (f.opacity = 0),
        a.effects.save(c, d),
        c
          .show()
 ...
 */ (function (a, b) {
  a.effects.pulsate = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = a.effects.setMode(c, b.options.mode || 'show');
 ...
 */ (function (a, b) {
  ((a.effects.puff = function (b) {
    return this.queue(function () {
      const c = a(this);
      const d = a.effects.setMode(c, b.options.mode || 'hide');
      const e = parseInt(b.options.percent, 10) || 150;
      const f = e / 100;
      const g = { height: c.height(), width: c.width() };
      (a.extend(b.options, {
        fade: !0,
        mode: d,
    ...
    (a.effects.scale = function (b) {
      return this.queue(function () {
        const c = a(this);
        const d = a.extend(!0, {}, b.options);
        const e = a.effects.setMode(c, b.options.mode || 'effect');
        const f =
          parseInt(b.options.percent, 10) ||
          (parseInt(b.options.percent, 10) == 0 ? 0 : e == 'hide' ? 0 : 100);
        const g = b.options.direction || 'both';
        const h = b.options.origin;
        e != 'effect' &&
          ((d.origin = h || ['middle', 'center']), (d.restore = !0));
        const i = { height: c.height(), width: c.width() };
    ...
    (a.effects.size = function (b) {
      return this.queue(function () {
        ...
        const j = a.effects.setMode(c, b.options.mode || 'effect');
        const k = b.options.restore || !1;
        const l = b.options.scale || 'both';
        const m = b.options.origin;
        const n = { height: c.height(), width: c.width() };
        ((c.from = b.options.from || n), (c.to = b.options.to || n));
        if (m) {
          const p = a.effects.getBaseline(m, n);
        ...
        if (l == 'content' || l == 'both')
          ((h = h.concat(['marginTop', 'marginBottom']).concat(g)),
            ...
            c.find('*[width]').each(function () {
              ...
              const c = { height: child.height(), width: child.width() };
              ((child.from = {
 ...
 */ (function (a, b) {
  a.effects.shake = function (b) {
    return this.queue(function () {
      ...
      const e = a.effects.setMode(c, b.options.mode || 'effect');
      const f = b.options.direction || 'left';
      const g = b.options.distance || 20;
      const h = b.options.times || 3;
      const i = b.duration || b.options.duration || 140;
      (a.effects.save(c, d), c.show(), a.effects.createWrapper(c));
      const j = f == 'up' || f == 'down' ? 'top' : 'left';
      const k = f == 'up' || f == 'left' ? 'pos' : 'neg';
      const l = {};
 ...
 */ (function (a, b) {
  a.effects.transfer = function (b) {
    return this.queue(function () {
      ...
      const g = c.offset();
      var h = a('<div class="ui-effects-transfer"></div>')
        .appendTo(document.body)
