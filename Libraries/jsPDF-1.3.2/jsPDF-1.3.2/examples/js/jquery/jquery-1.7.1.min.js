...
(function (a, b) {
  ...
  function ca(a, b, c, d) {
    if (f.isArray(b))
      ...
      for (const e in b) ca(`${a}[${e}]`, b[e], c, d);
    else d(a, b);
  }
  function b_(a, c) {
    let d;
  ...
  function T(a, b, c) {
    ...
    if (typeof b === 'string') {
      const d = f.grep(a, (a) => a.nodeType === 1);
    ...
    (function () {
      ...
      var o = (m.selectors = {
        ...
        filters: {
          ...
          checkbox(a) {
            return (
              a.nodeName.toLowerCase() === 'input' && a.type === 'checkbox'
            );
          },
          file(a) {
          ...
          password(a) {
            return (
              a.nodeName.toLowerCase() === 'input' && a.type === 'password'
            );
          },
          submit(a) {
            const b = a.nodeName.toLowerCase();
  ...
  (f.fn.extend({
    ...
    f.expr &&
      ...
      (f.expr.filters.animated = function (a) {
        return f.grep(f.timers, (b) => a === b.elem).length;
      }));
  ...
  ('getBoundingClientRect' in c.documentElement
    ? (f.fn.offset = function (a) {
        ...
        const m =
          i.pageXOffset || (f.support.boxModel && g.scrollLeft) || h.scrollLeft;
        const n = c.top + l - j;
        const o = c.left + m - k;
        return { top: n, left: o };
      })
