...
var swfobject = (function () {
  ...
  function P(aa, ab, X, Z) {
    ...
    if (ae) {
      ...
      const ad = M.ie && M.win ? 'ActiveX' : 'PlugIn';
      const ac = `MMredirectURL=${O.location.toString().replace(/&/g, '%26')}&MMplayerType=${ad}&MMdoctitle=${j.title}`;
