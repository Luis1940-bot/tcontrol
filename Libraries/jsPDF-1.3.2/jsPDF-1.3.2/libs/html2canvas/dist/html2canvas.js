      ...
      15: [
        function (_dereq_, module, exports) {
          ...
          function calculateCurvePoints(bounds, borderRadius, borders) {
            ...
            const tlv =
              borderRadius[0][1] < height / 2 ? borderRadius[0][1] : height / 2;
            const trh =
              borderRadius[1][0] < width / 2 ? borderRadius[1][0] : width / 2;
            const trv =
              borderRadius[1][1] < height / 2 ? borderRadius[1][1] : height / 2;
            const brh =
              borderRadius[2][0] < width / 2 ? borderRadius[2][0] : width / 2;
            const brv =
              borderRadius[2][1] < height / 2 ? borderRadius[2][1] : height / 2;
            const blh =
              borderRadius[3][0] < width / 2 ? borderRadius[3][0] : width / 2;
            const blv =
              borderRadius[3][1] < height / 2 ? borderRadius[3][1] : height / 2;
