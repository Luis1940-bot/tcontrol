...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='<?php echo BASE_URL ?>/Pages/ControlesDiarios/css/diarios.css?v=<?php echo (time()); ?>' media='screen'>
...
<body>
  ...
  <main>
    <table id='tableControlesDiarios'>
      <thead></thead>
      <tbody></tbody>
    </table>
  </main>
  ...
  <script type='module' src='<?php echo BASE_URL ?>/Pages/ControlesDiarios/diarios.js?v=<?php echo (time()); ?>'></script>
</body>
