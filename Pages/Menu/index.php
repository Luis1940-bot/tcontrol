...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='<?php echo BASE_URL ?>/Pages/Menu/menu.css?v=<?php echo (time()); ?>' media='screen'>
...
<body>
  ...
  <script type='module' src='<?php echo BASE_URL ?>/Pages/Menu/menu.js?v=<?php echo (time()); ?>'></script>
</body>
