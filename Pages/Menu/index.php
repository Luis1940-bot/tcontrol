...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='../../Pages/Menu/menu.css?v=<?php echo(time()); ?>' media='screen'>
...
<script type='module' src='../../Pages/Menu/menu.js?v=<?php echo(time()); ?>'></script>
</body>
</html>