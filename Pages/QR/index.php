...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='<?php echo BASE_URL ?>/Pages/QR/qr.css?v=<?php echo (time()); ?>' media='screen'>
...
<body>
  ...
  <script type='module' src='<?php echo BASE_URL ?>/Pages/QR/qr.js?v=<?php echo (time()); ?>'></script>
</body>
