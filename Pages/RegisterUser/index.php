...
<body>
  ...
  <script type='module' src='../../Pages/RegisterUser/register.js?v=<?php echo(time()); ?>'></script>
  <script type='module' src='../../Pages/RegisterUser/Controllers/traerRegistros.js?v=<?php echo(time()); ?>'></script>
</body>
</html>