...
function onOff(int $id, int $envioEmail): array
{
  try {
    ...
    $sql = "UPDATE LTYreporte SET envio_mail = ? WHERE idLTYreporte = ?";
    ...
    $stmt->bind_param("ii", $envioEmail, $id);
...
// $datos = '{"q":14,"ruta":"/habilitarEmail","rax":"&new=Wed May 21 2025 20:38:12 GMT-0300 (hora estándar de Argentina)","envioEmail":1}';
...
$envioEmail = isset($data['envioEmail']) && is_int($data['envioEmail']) ? $data['envioEmail'] : 0;
onOff($q, $envioEmail);
