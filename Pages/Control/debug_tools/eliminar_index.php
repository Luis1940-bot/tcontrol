...
$url = BASE_URL . "/index.php"; //*"https://test.tenkiweb.com/tcontrol/index.php";
...
if (isset($_SESSION['login_sso']['email'])) {
  ...
  if (SSO === null || SSO === 's_sso') {
    ...
    $url = BASE_URL . "/Pages/Login/index.php"; //*"https://test.tenkiweb.com/tcontrol/index.php";
  ...
  <script>
    (function() {
      if (!sessionStorage.getItem('reloaded')) {
        ...
        location.reload(true); // Primera recarga forzada
      } else if (!sessionStorage.getItem('reloadedTwice')) {
        sessionStorage.setItem('reloadedTwice', 'true');
        location.reload(true); // Segunda recarga forzada
      }
    })();
  </script>
