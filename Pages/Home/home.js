...
function verMisTickets() {
  try {
    // Como ya estamos en el Home, significa que el usuario está autenticado
    // Simplemente ir al historial de tickets
    const url = `${SERVER}/Pages/Soporte/historial.php`;
    window.location.href = url;
  } catch (error) {
