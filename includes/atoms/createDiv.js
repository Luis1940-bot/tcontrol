function createDiv(params) {
  ...
  params.id !== null ? nuevoDiv.setAttribute('id', params.id) : null
  params.text !== null ? (nuevoDiv.textContent = params.text) : null
  params.class !== null ? nuevoDiv.setAttribute('class', params.class) : null
  params.name !== null ? nuevoDiv.setAttribute('name', params.name) : null
