...
!(function (A, e) {
  ...
  function H(t, r) {
    ...
    const A = { next: e(0), throw: e(1), return: e(2) };
    return (
  ...
  const d =
    ...
    (B.fromDOMRectList = function (A, e) {
      e = Array.from(e).find((A) => A.width !== 0);
      return e
        ? new B(
            e.left + A.windowBounds.left,
            e.top + A.windowBounds.top,
  ...
  for (
    var f = function (A, e) {
      ...
      n = typeof Uint8Array === 'undefined' ? [] : new Uint8Array(256),
      s = 0;
    s < e.length;
    s++
  )
  ...
  for (
    let C = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',
      u = typeof Uint8Array === 'undefined' ? [] : new Uint8Array(256),
      F = 0;
    F < C.length;
    F++
  )
    ...
    const e = (B = (function (A, r) {
      ...
      return (
        A.forEach((A, e) => {
          ...
          if (e === 0) return n.push(e), B.push(J);
          t = B[e - 1];
          return iA.indexOf(t) === -1
    ...
    return [
      ...
      (r =
        A.wordBreak === 'break-all' || A.wordBreak === 'break-word'
          ? r.map((A) => ([R, J, AA].indexOf(A) !== -1 ? q : A))
          : r),
      A.wordBreak === 'keep-all'
        ? B.map((A, e) => A && t[e] >= 19968 && t[e] <= 40959)
        : void 0,
    ];
  }
  let y;
      ...
      next() {
        ...
        for (
          ...
          (A = (function (A, e, t, r, B) {
            ...
            var r = s >= 0 ? e[s] : 0;
            var B = e[o];
            if (i === 2 && B === 3) return tA;
            if (nA.indexOf(i) !== -1) return '!';
            if (nA.indexOf(B) !== -1) return tA;
            if (sA.indexOf(B) !== -1) return tA;
            if (E(n, e) === 8) return '÷';
            if (rA.get(A[n]) === 11) return tA;
            if ((i === Y || i === W) && rA.get(A[o]) === 11) return tA;
            if (i === 7 || B === 7) return tA;
            if (i === 9) return tA;
            if ([D, v, x].indexOf(i) === -1 && B === 9) return tA;
            if ([M, S, T, k, X].indexOf(B) !== -1) return tA;
            if (E(n, e) === V) return tA;
            if (p(23, V, n, e)) return tA;
            if (p([M, S], O, n, e)) return tA;
            if (p(12, 12, n, e)) return tA;
            if (i === D) return '÷';
            if (i === 23 || B === 23) return tA;
            if (B === 16 || i === 16) return '÷';
            if ([v, x, O].indexOf(B) !== -1 || i === 14) return tA;
            if (r === 36 && cA.indexOf(i) !== -1) return tA;
            if (i === X && B === 36) return tA;
            if (B === G) return tA;
            if (
              (BA.indexOf(B) !== -1 && i === R) ||
              (BA.indexOf(i) !== -1 && B === R)
              ...
              return tA;
            if (
              (i === P && [q, Y, W].indexOf(B) !== -1) ||
              ([q, Y, W].indexOf(i) !== -1 && B === N)
            )
              return tA;
            if (
              (BA.indexOf(i) !== -1 && oA.indexOf(B) !== -1) ||
              (oA.indexOf(i) !== -1 && BA.indexOf(B) !== -1)
            )
              return tA;
            if (
              ([P, N].indexOf(i) !== -1 &&
                (B === R || ([V, x].indexOf(B) !== -1 && e[1 + o] === R))) ||
              ([V, x].indexOf(i) !== -1 && B === R) ||
              (i === R && [R, X, k].indexOf(B) !== -1)
            )
              return tA;
            if ([R, X, k, M, S].indexOf(B) !== -1)
              for (var Q = n; Q >= 0; ) {
                if ((c = e[Q]) === R) return tA;
                if ([X, k].indexOf(c) === -1) break;
                Q--;
              }
            if ([P, N].indexOf(B) !== -1)
              for (var c, Q = [M, S].indexOf(i) !== -1 ? s : n; Q >= 0; ) {
                if ((c = e[Q]) === R) return tA;
                if ([X, k].indexOf(c) === -1) break;
                Q--;
              }
            if (
              (j === i && [j, z, Z, _].indexOf(B) !== -1) ||
              ([z, Z].indexOf(i) !== -1 && [z, $].indexOf(B) !== -1) ||
              ([$, _].indexOf(i) !== -1 && B === $)
            )
              return tA;
            if (
              (QA.indexOf(i) !== -1 && [G, N].indexOf(B) !== -1) ||
              (QA.indexOf(B) !== -1 && i === P)
            )
              return tA;
            if (BA.indexOf(i) !== -1 && BA.indexOf(B) !== -1) return tA;
            if (i === k && BA.indexOf(B) !== -1) return tA;
            if (
              (BA.concat(R).indexOf(i) !== -1 &&
                B === V &&
                eA.indexOf(A[o]) === -1) ||
              (BA.concat(R).indexOf(B) !== -1 && i === S)
            )
              return tA;
            if (i === 41 && B === 41) {
              for (var a = t[n], g = 1; a > 0 && e[--a] === 41; ) g++;
              if (g % 2 != 0) return tA;
            }
            return i === Y && B === W ? tA : '÷';
          })(t, B, r, ++i, n)) === tA;
  ...
  function lA(A) {
    return UA(A) || (A >= 65 && A <= 70) || (A >= 97 && A <= 102);
  }
  function CA(A) {
  ...
  function FA(A) {
    return uA(A) || UA(A) || A === 45;
  }
  function hA(A, e) {
    return A === 92 && e !== 10;
  }
  function dA(A, e, t) {
    return A === 45 ? uA(e) || hA(e, t) : !!uA(A) || (A === 92 && e !== 10);
  }
  function fA(A, e, t) {
    return A === 43 || A === 45
      ? !!UA(e) || (e === 46 && UA(t))
  ...
  const PA =
    ...
    (XA.prototype.consumeToken = function () {
      ...
      switch (A) {
        ...
        case 35:
          ...
          break;
        case 36:
          if (this.peekCodePoint(0) === 61) return this.consumeCodePoint(), IA;
          break;
        case 39:
        ...
        case 41:
          return pA;
        case 42:
          if (this.peekCodePoint(0) === 61) return this.consumeCodePoint(), vA;
          break;
        case 43:
        ...
        case 47:
          if (this.peekCodePoint(0) === 42)
            for (this.consumeCodePoint(); ; ) {
              ...
              if (s === 42 && (s = this.consumeCodePoint()) === 47)
        ...
        case 93:
          return kA;
        case 61:
          if (this.peekCodePoint(0) === 61) return this.consumeCodePoint(), yA;
          break;
        case 123:
          return bA;
        case 125:
        ...
        case 124:
          if (this.peekCodePoint(0) === 61) return this.consumeCodePoint(), mA;
          if (this.peekCodePoint(0) === 124) return this.consumeCodePoint(), KA;
          break;
        case 126:
          if (this.peekCodePoint(0) === 61) return this.consumeCodePoint(), LA;
          break;
        case -1:
          return NA;
      }
    ...
    (XA.prototype.consumeUnicodeRangeToken = function () {
      ...
      if (this.peekCodePoint(0) === 45 && lA(this.peekCodePoint(1))) {
    ...
    (XA.prototype.consumeStringToken = function (A) {
      for (let e = '', t = 0; ; ) {
        ...
        if (B === 10) return this._value.splice(0, t), MA;
        B !== 92 ||
          ((r = this._value[t + 1]) !== -1 &&
            void 0 !== r &&
            (r === 10
    ...
    (XA.prototype.consumeNumericToken = function () {
      ...
      const e = A[0];
      const t = A[1];
      const r = this.peekCodePoint(0);
      const B = this.peekCodePoint(1);
    ...
    (XA.prototype.consumeEscapedCodePoint = function () {
      ...
      if (lA(e)) {
        ...
        return r === 0 || ((A = r) >= 55296 && A <= 57343) || r > 1114111
          ? 65533
          : r;
      }
      return e === -1 ? 65533 : e;
  ...
  var ae = { type: 17, number: 0, flags: 4 };
  const ge = { type: 16, number: 50, flags: 4 };
  var we = { type: 16, number: 100, flags: 4 };
  var Ue = function (A, e) {
  ...
  const ue = function (A, e) {
    ...
    if (e.type === 5) {
      if (e.value.length === 3) {
        ...
        var B = e.value.substring(1, 2);
        var n = e.value.substring(2, 3);
        return Fe(
          parseInt(r + r, 16),
          parseInt(B + B, 16),
          parseInt(n + n, 16),
  ...
  function pe(A, t) {
    ...
    e.stop === null && (e.stop = ae), r.stop === null && (r.stop = we);
    ...
    for (var i = null, s = 0; s < B.length; s++) {
      ...
      if (Q === null) i === null && (i = s);
        ...
        for (let c = s - i, a = (Q - B[i - 1]) / (1 + c), g = 1; g <= c; g++)
          B[i + g - 1] = a * g;
        i = null;
      }
    }
  ...
  function Ee(A, e, t) {
    ...
    var B = Math.abs(e * Math.sin(r)) + Math.abs(t * Math.cos(r));
    var n = e / 2;
    var s = t / 2;
    var e = B / 2;
    var t = Math.sin(r - Math.PI / 2) * e;
    var e = Math.cos(r - Math.PI / 2) * e;
  ...
  var Ke = function (A, e) {
    ...
    let n = t[2];
    var e = t[3];
    var t = (r.type === 17 ? Ce(r.number) : le(A, r)) / (2 * Math.PI);
    var A = te(B) ? B.number / 100 : 0;
    var r = te(n) ? n.number / 100 : 0;
    var B = void 0 !== e && te(e) ? Ue(e, 1) : 1;
    if (A == 0) return Fe(255 * r, 255 * r, 255 * r, 1);
    ...
    return (
      Ae(A).forEach((A, e) => {
        if (e === 0) {
          ...
          if (
            e.type === 20 &&
            ['top', 'left', 'right', 'bottom'].indexOf(e.value) !== -1
          )
            return void (r = se(A));
  ...
  const ve = 'closest-side';
  const xe = 'farthest-side';
  const Me = 'closest-corner';
  const Se = 'farthest-corner';
  const Te = 'ellipse';
  const Ge = 'contain';
  var he = function (r, A) {
    let B = 0;
  ...
  const Oe = function (A, e) {
    ...
    if (e.type !== 18) throw new Error(`Unsupported image type ${e.type}`);
    t = ke[e.name];
    if (void 0 === t)
      throw new Error(
    ...
    'linear-gradient': function (t, A) {
      ...
      return (
        Ae(A).forEach((A, e) => {
          if (e === 0) {
            e = A[0];
            if (e.type === 20 && e.value === 'to') return void (r = se(A));
    ...
    '-webkit-gradient': function (r, A) {
      ...
      return (
        Ae(A).forEach((A, e) => {
          ...
          var A = A[0];
          if (e === 0) {
            if (_A(A) && A.value === 'linear') return void (n = 1);
            if (_A(A) && A.value === 'radial') return void (n = 2);
          }
          A.type === 18 &&
            (A.name === 'from'
  ...
  const et = he('top-left');
  const tt = he('top-right');
  const rt = he('bottom-right');
  const Bt = he('bottom-left');
  var he = function (A) {
    return {
      name: `border-${A}-style`,
      initialValue: 'solid',
  ...
  const lt = {
    ...
    type: 1,
    parse(A, e) {
      return e.filter(_A).reduce((A, e) => A | Ct(e.value), 0);
    },
  };
  var Ct = function (A) {
    switch (A) {
  ...
  const ht = {
    ...
    type: 2,
    parse(A, e) {
      return e !== 'strict' ? We.NORMAL : We.STRICT;
    },
  };
  const dt = {
    name: 'line-height',
  ...
  const ft = {
    ...
    prefix: !1,
    parse(A, e) {
      return e.type === 20 && e.value === 'none' ? null : Oe(A, e);
    },
  };
  const Ht = {
  ...
  var Vt = {
    matrix(A) {
      A = A.filter((A) => A.type === 17).map((A) => A.number);
    ...
    matrix3d(A) {
      ...
      const s = e[12];
      var A = e[13];
      return e[14], e[15], e.length === 16 ? [t, r, B, n, s, A] : null;
    },
  };
  var he = { type: 16, number: 50, flags: 4 };
  const kt = [he, he];
  const Rt = {
  ...
  const $t = {
    ...
    prefix: !1,
    parse(A, e) {
      return ZA(e) ? e.number : !_A(e) || e.value !== 'bold' ? 400 : 700;
    },
  };
  const Ar = {
    name: 'font-variant',
    ...
    prefix: !1,
    parse(A, e) {
      return e.filter(_A).map((A) => A.value);
    },
  };
  const er = {
    name: 'font-style',
  ...
  const nr = {
    ...
    type: 1,
    parse(e, A) {
      return A.filter(WA).map((A) => Wt(e, A));
    },
  };
  const sr = {
    name: 'quotes',
  ...
  function gr(A, e) {
    ...
    (this.overflowX = t[0]),
      ...
      (this.textDecorationColor = lr(
        A,
        _t,
        (t = e.textDecorationColor) !== null && void 0 !== t ? t : e.color,
      )),
  ...
  for (
    var wr = function (A, e) {
      ...
      lr = function (A, e, t) {
        const r = new PA();
        var t = t != null ? t.toString() : e.initialValue;
        r.write(t);
      ...
      ur = function (A, e) {
        (this.context = A),
          ...
          JB(e) &&
            (this.styles.animationDuration.some((A) => A > 0) &&
      ...
      hr = typeof Uint8Array === 'undefined' ? [] : new Uint8Array(256),
      dr = 0;
    dr < Fr.length;
    dr++
  )
      ...
      next() {
        ...
        for (
          ...
          (A = (function (A, e) {
            ...
            const B = A[e - 1];
            var e = A[e];
            if (B === 2 && e === 3) return Rr;
            if (B === 2 || B === 3 || B === 4) return '÷';
            if (e === 2 || e === 3 || e === 4) return '÷';
            if (B === Tr && [Tr, Gr, Or, Vr].indexOf(e) !== -1) return Rr;
            if (!((B !== Or && B !== Gr) || (e !== Gr && e !== 10))) return Rr;
            if ((B === Vr || B === 10) && e === 10) return Rr;
            if (e === 13 || e === 5) return Rr;
            if (e === 7) return Rr;
            if (B === 1) return Rr;
            if (B === 13 && e === 14) {
              for (; r === 5; ) r = A[--t];
  ...
  var Rr = '×';
  const Nr = function (A, e, t, r, B) {
    var n = 'http://www.w3.org/2000/svg';
    const s = document.createElementNS(n, 'svg');
  ...
  var Xr = {
    ...
    get SUPPORT_SVG_DRAWING() {
      const A = (function (A) {
        const e = new Image();
        const t = A.createElement('canvas');
          ...
          ? (function (t) {
              ...
              return (
                ...
                Pr(e)
                  ...
                  .then(
                    (A) => (
                      B.drawImage(A, 0, 0), Lr(B.getImageData(0, 0, r, r).data)
                    ),
                  )
                  .catch(() => !1)
              );
    ...
    get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
      const A = !(typeof Intl === 'undefined' || !Intl.Segmenter);
      return (
  ...
  const Jr = function (A, e) {
    (this.text = A), (this.bounds = e);
  };
  const Yr = function (A, e) {
  ...
  const _r = function (A, e) {
    return e.letterSpacing !== 0
      ? Zr(A)
      : (function (A, e) {
          if (Xr.SUPPORT_NATIVE_TEXT_SEGMENTATION) {
  ...
  const qr = [32, 160, 4961, 65792, 65793, 4153, 4241];
  var jr = function (A, e) {
    for (
      var t,
        r = wA(A, {
    ...
    (this.text = $r(e.data, t.textTransform)),
      (this.textBounds =
        ...
        A.forEach((A) => {
          ...
          let t;
          let r;
          n.textDecorationLine.length || A.trim().length > 0
            ? Xr.SUPPORT_RANGE_BOUNDS
              ? (r = Wr(s, i, A.length).getClientRects()).length > 1
                ? ((e = Zr(A)),
                  (t = 0),
                  e.forEach((A) => {
                    o.push(
  ...
  var AB = /(^|\s|:|-|\(|\))([a-z])/g;
  var eB = function (A, e, t) {
    return A.length > 0 ? e + t.toUpperCase() : A;
  };
  const tB = (A(rB, (Sr = ur)), rB);
  function rB(A, e) {
  ...
  let oB;
  const iB = (A(QB, (oB = ur)), QB);
  function QB(A, e) {
    const t = oB.call(this, A, e) || this;
  ...
  const FB = [{ type: 16, flags: 0, number: 50 }];
  const hB = 'checkbox';
  const dB = 'radio';
  const fB = 'password';
  const HB = 707406591;
  const pB = (A(EB, (CB = ur)), EB);
  function EB(A, e) {
  ...
  function Qn(A, e, t, r, B) {
    ...
    return (
      (A < 0 ? '-' : '') +
      (on(Math.abs(A), n, r, (A) => g(Math.floor(A % n) + e)) + B)
    );
  }
  function cn(A, e, t) {
    void 0 === t && (t = '. ');
    const r = e.length;
    return on(Math.abs(A), r, !1, (A) => e[Math.floor(A % r)]) + t;
  }
  function an(A, e, t, r, B, n) {
    if (A < -9999 || A > 9999) return Fn(A, 4, B.length > 0);
    let s = Math.abs(A);
    let o = B;
    if (s === 0) return e[0] + o;
  ...
  const hn = 'data-html2canvas-ignore';
  const dn =
    ((fn.prototype.toIFrame = function (A, r) {
      ...
      const t = A.defaultView.pageXOffset;
      const n = A.defaultView.pageYOffset;
      const s = B.contentWindow;
      const o = s.document;
      var A = In(B).then(() =>
      ...
      try {
        ...
        if (e && e.cssRules) {
          const t = [].slice
            ...
            .reduce(
              (A, e) =>
                e && typeof e.cssText === 'string' ? A + e.cssText : A,
              '',
            );
          const r = A.cloneNode(!1);
        ...
        return (
          s &&
            (!this.options.allowTaint && n
              ...
              : (!(r =
                  (A = e.getContext('webgl2')) !== null && void 0 !== A
                    ? A
                    : e.getContext('webgl')) ||
                  (!1 ===
                    ((B = r.getContextAttributes()) == null
                      ? void 0
    ...
    (fn.prototype.cloneChildNodes = function (A, e, t) {
      for (
        ...
        XB(n) && rn(n) && typeof n.assignedNodes === 'function'
          ? (r = n.assignedNodes()).length &&
            r.forEach((A) => B.appendChildNode(e, A, t))
    ...
    (fn.prototype.cloneNode = function (A, e) {
      ...
      if (t && XB(A) && (JB(A) || YB(A))) {
        ...
        const B = t.getComputedStyle(A);
        let n = t.getComputedStyle(A, ':before');
        let s = t.getComputedStyle(A, ':after');
    ...
    (fn.prototype.resolvePseudoContent = function (o, A, e, t) {
      ...
      if (e) {
        ...
        if (
          ...
          const a = Q.createElement('html2canvaspseudoelement');
          Kn(e, a),
            c.content.forEach((A) => {
              if (A.type === 0) a.appendChild(Q.createTextNode(A.value));
              else if (A.type === 22) {
                  ...
                  : A.name === 'counter'
                    ...
                    : A.name === 'counters' &&
                      ...
                      B &&
                        ...
                        (s = s && s.type === 0 ? s.value : ''),
                        (s = B.map((A) => Fn(A, n, !1)).join(s)),
  ...
  const yn = ['all', 'd', 'content'];
  var Kn = function (A, e) {
    for (let t = A.length - 1; t >= 0; t--) {
      const r = A.item(t);
      yn.indexOf(r) === -1 && e.style.setProperty(r, A.getPropertyValue(r));
    }
    return e;
  };
  var mn = function (A) {
  ...
  var Dn = '___html2canvas___pseudoelement_before';
  var vn = '___html2canvas___pseudoelement_after';
                ...
                [
                  ...
                  new Promise((A, e) => {
                    ...
                    (t.onload = function () {
                      ...
                      (t.src = B),
                      !0 === t.complete && setTimeout(() => A(t), 500),
    ...
    (Vn.prototype.proxy = function (s) {
      ...
      return new Promise((e, t) => {
          ...
          B.status === 200
            ? r == 'text'
              ...
              : ((A = new FileReader()).addEventListener(
                ...
                A.addEventListener('error', (A) => t(A), !1),
        ...
        B.open('GET', `${i + n}url=${encodeURIComponent(s)}&responseType=${r}`),
          r != 'text' && B instanceof XMLHttpRequest && (B.responseType = r),
  ...
  const kn = /^data:image\/svg\+xml/i;
  const Rn = /^data:image\/.*;base64,/i;
  const Nn = /^data:image\/.*/i;
  var Pn = function (A) {
  ...
  var Wn = function (A) {
    return A.substr(-3).toLowerCase() === 'svg' || kn.test(A);
  };
  const Zn =
  ...
  const jn =
    ((zn.prototype.subdivide = function (A, e) {
      const t = qn(this.start, this.startControl, A);
      var r = qn(this.startControl, this.endControl, A);
      const B = qn(this.endControl, this.end, A);
      const n = qn(t, r, A);
      var r = qn(r, B, A);
      var A = qn(n, r, A);
  ...
  const es = function (A) {
    const e = A.styles;
    const t = A.bounds;
    let r = (C = Be(e.borderTopLeftRadius, t.width, t.height))[0];
    let B = C[1];
    let n = (u = Be(e.borderTopRightRadius, t.width, t.height))[0];
    let s = u[1];
    let o = (F = Be(e.borderBottomRightRadius, t.width, t.height))[0];
    let i = F[1];
    let Q = (h = Be(e.borderBottomLeftRadius, t.width, t.height))[0];
    let c = h[1];
    (d = []).push((r + n) / t.width),
      d.push((Q + o) / t.width),
      d.push((B + c) / t.height),
    ...
    const w = t.width - o;
    const U = t.height - c;
    const l = e.borderTopWidth;
    var C = e.borderRightWidth;
    var u = e.borderBottomWidth;
    var F = e.borderLeftWidth;
    var h = Ue(e.paddingTop, A.bounds.width);
    var d = Ue(e.paddingRight, A.bounds.width);
    var f = Ue(e.paddingBottom, A.bounds.width);
    var A = Ue(e.paddingLeft, A.bounds.width);
  ...
  function ns(A, t) {
    return A.length === t.length && A.some((A, e) => A === t[e]);
  }
  ...
  const as =
    ((gs.prototype.getEffects = function (e) {
      for (
        var A = [2, 3].indexOf(this.container.styles.position) === -1,
          t = this.parent,
        ...
        var B;
        var n;
        const s = t.effects.filter((A) => !Bs(A));
        A || t.container.styles.position !== 0 || !t.parent
          ? (r.unshift.apply(r, s),
            (A = [2, 3].indexOf(t.container.styles.position) === -1),
      ...
      return r.filter((A) => Pt(A.target, e));
    }),
    gs);
  function gs(A, e) {
    let t;
  ...
  function ls(A) {
    const e = A.styles;
    const t = A.bounds;
    const r = Ue(e.paddingLeft, t.width);
    const B = Ue(e.paddingRight, t.width);
    const n = Ue(e.paddingTop, t.width);
    var A = Ue(e.paddingBottom, t.width);
    return t.add(
      r + e.borderLeftWidth,
      n + e.borderTopWidth,
  ...
  function Cs(A, e, t) {
    const r =
      ...
      (n = A),
      B === 0 ? n.bounds : (B === 2 ? ls : Us)(n));
    var B =
      ((s = Es(A.styles.backgroundClip, e)),
      (o = A),
      s === 0 ? o.bounds : (s === 2 ? ls : Us)(o));
    var n = ps(Es(A.styles.backgroundSize, e), t, r);
    var s = n[0];
    var o = n[1];
    var t = Be(Es(A.styles.backgroundPosition, e), r.width - s, r.height - o);
    return [
  ...
  const hs = function (Q, c, a, g) {
    Q.container.elements.forEach((A) => {
      const e = Pt(A.flags, 4);
      let t = Pt(A.flags, 2);
      const r = new as(A, Q);
  ...
  var ds = function (A, e) {
    for (
      let t = A instanceof UB ? A.start : 1,
  ...
  const ys = 'Hidden Text';
  const Ks =
    ((ms.prototype.parseMetrics = function (A, e) {
      const t = this._document.createElement('div');
      let r = this._document.createElement('img');
  ...
  const bs =
    ...
    (Ds.prototype.createFontStyle = function (A) {
      const e = A.fontVariant
        .filter((A) => A === 'normal' || A === 'small-caps')
        .join('');
      const t = Gs(A.fontFamily).join(', ');
      const r = WA(A.fontSize)
                  ...
                  case 0:
                    ...
                    e.length &&
                      ...
                      Q.textDecorationLine.length &&
                        ...
                        Q.textDecorationLine.forEach((A) => {
                          switch (A) {
                            case 1:
                              o.ctx.fillRect(
                                t.bounds.left,
        ...
        return H(this, function (A) {
          switch (A.label) {
            ...
            case 14:
              ...
              if ((c = e.styles.listStyleImage).type !== 0) return [3, 18];
    ...
    (Ds.prototype.formatPath = function (A) {
      ...
      A.forEach((A, e) => {
        ...
        e === 0 ? r.ctx.moveTo(t.x, t.y) : r.ctx.lineTo(t.x, t.y),
          $n(A) &&
            r.ctx.bezierCurveTo(
              A.startControl.x,
              A.startControl.y,
    ...
    (Ds.prototype.resizeImage = function (A, e, t) {
      ...
      var r = (
        (r = this.canvas.ownerDocument) !== null && void 0 !== r ? r : document
                      ...
                      case 5:
                        e.type === 1
                          ? ((F = Cs(f, h, [null, null, null])),
                            ...
                            pe(e.stops, l).forEach((A) =>
                              n.addColorStop(A.stop, ie(A.color)),
                            ),
                            (C.fillStyle = n),
                            C.fillRect(0, 0, c, a),
                            c > 0 &&
                          ...
                          : e.type === 2 &&
                            ...
                            (c = u[3]),
                            (a = u[4]),
                            (l = e.position.length === 0 ? [ge] : e.position),
                            (g = Ue(l[0], c)),
                            (w = Ue(l[l.length - 1], a)),
                            ...
                            F > 0 &&
                              ...
                              pe(e.stops, 2 * F).forEach((A) =>
                                U.addColorStop(A.stop, ie(A.color)),
                              ),
                              d.path(o),
                              (d.ctx.fillStyle = U),
                              F !== u
      ...
      return a(this, void 0, void 0, function () {
        ...
        return H(this, function (A) {
          switch (A.label) {
            ...
            case 3:
              return s < o.length
                ? (i = o[s]).style !== 0 && !oe(i.color) && i.width > 0
                  ? i.style !== 2
                    ? [3, 5]
                    : [
                        4,
        ...
        return H(this, function (A) {
          return (
            ...
            (o = $n(e[1])
              ...
              : ((r = e[1].x), e[1].y)),
            (B = U === 0 || U === 2 ? Math.abs(t - r) : Math.abs(s - o)),
            this.ctx.beginPath(),
            C === 3 ? this.formatPath(Q) : this.formatPath(e.slice(0, 2)),
            (n = w < 3 ? 3 * w : 2 * w),
            (s = w < 3 ? 2 * w : w),
            C === 3 && (s = n = w),
            (o = !0),
  ...
  const Ts = ['-apple-system', 'system-ui'];
  var Gs = function (A) {
    return /iPhone OS 15_(0|1)/.test(window.navigator.userAgent)
      ? A.filter((A) => Ts.indexOf(A) === -1)
      : A;
  };
  const Os =
    (A(Vs, (vs = he)),
  ...
  function Xs(A, e) {
    (this.windowBounds = e),
      ...
      (this.cache =
        (e = A.cache) !== null && void 0 !== e ? e : new On(this, A));
  }
  typeof window !== 'undefined' && Tn.setContext(window);
  const Js = function (u, F) {
      ...
      return H(this, (A) => {
        switch (A.label) {
          case 0:
            ...
            return (
              (w = {
                allowTaint: (U = F.allowTaint) !== null && void 0 !== U && U,
                imageTimeout:
                  (c = F.imageTimeout) !== null && void 0 !== c ? c : 15e3,
                proxy: F.proxy,
                useCORS: (a = F.useCORS) !== null && void 0 !== a && a,
              }),
              (U = {
                logging: (g = F.logging) === null || void 0 === g || g,
                cache: F.cache,
                ...w,
              }),
              (c = {
                windowWidth:
                  (c = F.windowWidth) !== null && void 0 !== c
                    ? c
                    : t.innerWidth,
                windowHeight:
                  (a = F.windowHeight) !== null && void 0 !== a
                    ? a
                    : t.innerHeight,
                scrollX:
                  (g = F.scrollX) !== null && void 0 !== g ? g : t.pageXOffset,
                scrollY:
                  (w = F.scrollY) !== null && void 0 !== w ? w : t.pageYOffset,
              }),
              (a = new d(c.scrollX, c.scrollY, c.windowWidth, c.windowHeight)),
              (g = new Ps(U, a)),
              (c =
                (w = F.foreignObjectRendering) !== null && void 0 !== w && w),
              (w = {
                allowTaint: (U = F.allowTaint) !== null && void 0 !== U && U,
                onclone: F.onclone,
          ...
          case 1:
            ...
            (l = {
              ...
              scale:
                (l =
                  (l = F.scale) !== null && void 0 !== l
                    ? l
                    : t.devicePixelRatio) !== null && void 0 !== l
                  ? l
                  : 1,
              x: ((l = F.x) !== null && void 0 !== l ? l : 0) + s,
              y: ((l = F.y) !== null && void 0 !== l ? l : 0) + o,
              width: (l = F.width) !== null && void 0 !== l ? l : Math.ceil(B),
              height:
                (l = F.height) !== null && void 0 !== l ? l : Math.ceil(n),
            }),
            c)
              ? (g.logger.debug(
          ...
          case 5:
            return (
              ((C = F.removeContainer) !== null && void 0 !== C && !C) ||
                dn.destroy(r) ||
                g.logger.error(
