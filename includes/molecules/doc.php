...
<head>
  ...
  <link rel='stylesheet' type='text/css' href='<?php echo $baseUrl ?>/assets/css/doc.css' media='screen'>
  <title>Tenki</title>
</head>
...
<body>
  <div class='div-encabezadoDoc'>
    <div class='div-ubicacionDoc'>
      ...
      <img id='imgDoc' src='<?php echo $baseUrl ?>/assets/img/glass.png' alt='' class='icono-busqueda'>
    </div>
  </div>
</body>
