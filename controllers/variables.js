...
const objPerson = {
  ...
  divContent: {
    id: 'idDivPerson',
    position: 'absolute',
    top: '60px', // Ajustar según la altura del header o del botón
    right: '2vw',
    width: '30vw',
    minWidth: '220px',
    maxWidth: '400px',
...
const avisoListandoControles = {
  ...
  spinner: {
    ...
    style: '', // Puedes agregar estilos inline si lo necesitas
    ariaLabel: 'Cargando...',
    display: 'inline-block',
    color: '#fff',
    size: '32px', // tamaño sugerido
